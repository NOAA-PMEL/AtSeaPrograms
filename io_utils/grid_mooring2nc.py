...
"""
 ...
 2016-08-03: created to archive gridded mooring data timeseries
...
class GriddedNC(object):
    ...
    def file_create(self):
            rootgrpID = Dataset(self.savefile, GriddedNC.nc_read, format=GriddedNC.nc_format)
    ...
    def add_history(self, new_history):
        ...
        try:
            ...
            self.rootgrpID.History = datetime.datetime.utcnow().strftime("%B %d, %Y %H:%M UTC")\
                    + ' ' + new_history + '\n'                    
    def close(self):
